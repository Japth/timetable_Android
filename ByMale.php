<?php
  ...
  $result = mysqli_query($con, "SELECT COURSE.courseID, COURSE.courseGrade, COURSE.courseTitle, COURSE.courseProfessor, COURSE.courseCredit
      , COURSE.courseDivide, COURSE.coursePersonnel, COURSE.courseTime FROM SCHEDULE, COURSE, USER WHERE USER.userGender = 'Male' AND
      ...
      DESC LIMIT 5;"); //강의 신청자가 남성일때 가장 많이 신청한 강의를 내림차순으로 5개까지 강의 정보 출력
